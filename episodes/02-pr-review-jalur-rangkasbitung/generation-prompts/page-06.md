# Episode 02 · Page 6 — Sampai Tujuan

**Save as:** `../results/ep02_page06_v001.png` · **Layout:** `2-STACK` · **Panels:** 2 · **Bubbles:** 2
...
episodes/02-pr-review-jalur-rangkasbitung/results/ep02_page05_v001.png   ← style reference: previous page (use the approved version)
```

**Canary:** the page shows no title. If "Sampai Tujuan" appears anywhere, this prompt did not run as
written. Check the lobby order first — reception desk before the gates — and then that Kai is not a
second Deerock.
...
On this page: backpack on his back in Panel 1 and being lowered beside his chair in Panel 2. A
lanyard with an access card around his neck. No headphones on him or around his neck.
...
Kai carries a takeaway coffee cup.

Deerock appears in both panels; Kai only in Panel 2.
...
Panel 1 on top, full width, about 45% of the page height. Panel 2 below it, full width, the rest
of the page. One thin, straight, horizontal white gutter between them.

=== PANELS ===

PANEL 1 (top) — 08:45. NEXA WORKSPACE LOBBY, exactly as described in SETS. Medium shot from the
lift side of the access gates, angled back toward the entrance. Deerock walks through a glass access
gate toward the camera, tapping the access card on his lanyard against the reader, backpack on his
back. He looks hollow-eyed and drained — shoulders low, gaze empty, overshirt a little rumpled from
the crush — but his expression stays small and contained. Behind him, in the background, the reception
desk and the pale marble wall with the NEXA lettering. Neutral lobby light with daylight from the
glass façade.
Thought bubble, Deerock: Rencana tidur 40 menit. Dapetnya 10.

PANEL 2 (bottom) — 08:50. NEXA OPEN WORKSPACE, DEEROCK'S DESK. Eye-level medium two-shot from the
aisle. Deerock has just sat down and is lowering his backpack beside his chair. Kai strides over
from the aisle, beaming, a takeaway coffee cup in one hand, headphones around his neck. Soft morning
window light.
Speech bubble, Kai: Thanks, Deerock! Cepet banget approve PR-nya.

=== TEXT POLICY ===
The ONLY text anywhere on this page is: Deerock's thought bubble and the NEXA lettering on the
marble wall in Panel 1; Kai's speech bubble in Panel 2. Write "Deerock" in full. Spell every line
exactly as written. Monitors and other screens are unreadable. Nothing else is written anywhere.
...
The access gates are never in front of the reception. No open workspace is visible from the lobby.
