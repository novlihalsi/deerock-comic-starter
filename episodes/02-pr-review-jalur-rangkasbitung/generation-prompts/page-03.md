# Episode 02 · Page 3 — Tidur Ayam

**Save as:** `../results/ep02_page03_v001.png` · **Layout:** `1-FULL` · **Panels:** 1 · **Bubbles:** 1
...
episodes/02-pr-review-jalur-rangkasbitung/results/ep02_page02_v001.png   ← style reference: previous page (use the approved version)
```

**Canary:** the page shows no title. If "Tidur Ayam" appears anywhere, this prompt did not run as written.
Check Deerock's hands first: they must not be on a strap or a pole — the crowd is holding him up,
which is the joke.
...
A single 4:5 portrait comic page (1080 x 1350) consisting of ONE single full-page panel.
...
Muted cool palette with subtle purple and blue accents. The whole page is ONE single panel with no
panel border and no gutter. FULL BLEED: the artwork runs right to all four edges of the canvas — no
white margin, border or frame around the page. Consistent line weight, eye size and face proportion across
...
On this page: backpack worn on his FRONT, squashed flat by the crowd. Over-ear headphones ON HIS
HEAD, over his ears — never around his neck. No lanyard.
...
PANEL — 07:35. KRL CARRIAGE, MORNING RUSH. Slightly elevated medium-wide shot from along the aisle,
Deerock in the centre of the page. He is wedged upright in the packed crowd, bodies pressed against
him on every side. His hands rest on the backpack in front of him — he is NOT holding a strap or a
pole; the straps overhead are all held by other commuters' hands. The crowd is what keeps him
standing. Headphones on, eyes closing, a small contented calm on his face. Around him, commuters
stand patient and a little sleepy. Cool window daylight, flat carriage lighting.
Thought bubble, Deerock, near the top of the page: Waktunya tidur ayam. 40 menit. Nggak bakal jatuh juga.

=== TEXT POLICY ===
The ONLY text anywhere on this page is Deerock's thought bubble. Spell it exactly as written. The
route map, the ceiling info display and every other sign are unreadable. Nothing else is written
anywhere.
...
Deerock does not hold a strap or a pole. His headphones are on his head, never around his neck. He wears no lanyard.
