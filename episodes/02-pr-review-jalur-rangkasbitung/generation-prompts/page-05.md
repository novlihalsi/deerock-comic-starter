# Episode 02 · Page 5 — Perjuangan Layar Kecil

**Save as:** `../results/ep02_page05_v001.png` · **Layout:** `2-SIDE` · **Panels:** 2 · **Bubbles:** 2
...
episodes/02-pr-review-jalur-rangkasbitung/results/ep02_page04_v001.png   ← style reference: previous page (use the approved version)
```

**Canary:** the page shows no title. If "Perjuangan Layar Kecil" appears anywhere, this prompt did not run as
written. Check the layout first: two panels side by side, the right one tall and narrow — not two
stacked rows.
...
Deerock is the only named character on this page, among anonymous commuters.
...
Two tall panels side by side, each the full height of the page: Panel 1 on the left, about 60% of
the width; Panel 2 on the right, the rest. One thin, straight, vertical white gutter between them.

=== PANELS ===

PANEL 1 (left) — 07:50. KRL CARRIAGE, MORNING RUSH. Medium close-up in three-quarter front view.
Deerock has worked one arm free and holds his phone close to his face, squinting at it behind his
glasses with a tight, small frown; his other arm is still pinned by the crowd. The carriage lurches:
the standing bodies around him all lean the same way, a stranger's shoulder presses into his and an
elbow digs into his side. Headphones on. The phone's screen faces him. Cool window daylight.
Thought bubble, Deerock: Review ratusan baris kode… di layar HP… sambil terguncang…

PANEL 2 (right, tall and narrow) — 07:55. Close over Deerock's shoulder: the edge of his cheek,
glasses and headphones in the near foreground, and his phone filling most of the tall panel, its
screen facing him — the reader sees it over his shoulder. On the screen, a pull request diff: red
and green highlighted rows of tiny, cramped code that wraps and runs past the edges of the small
screen. The code is schematic — nothing on it is readable.
Thought bubble, Deerock, at the top of the panel: Ini fungsi apa sih, panjang banget…

=== TEXT POLICY ===
The ONLY text anywhere on this page is Deerock's two thought bubbles. Spell them exactly as
written. The code on the phone is schematic and unreadable. Nothing else is written anywhere.
