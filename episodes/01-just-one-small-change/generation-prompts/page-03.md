# Episode 01 · Page 3 — Dibenerin bareng

**Save as:** `../results/ep01_page03_v001.png` · **Panels:** 3 · **Bubbles:** 5
...
Also attach approved `../results/ep01_page02_v001.png` and add the STYLE REFERENCE line — see [`README.md`](README.md).
...
finger raised as he catches himself, his grin turning into a sheepish laugh. Bright mid-morning daylight.
...
exactly as written. The iPad sketch, code and Mika's phone are unreadable. Nothing else is written
anywhere.
